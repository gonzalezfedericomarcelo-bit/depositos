...
-- Tiempo de generación: 11-12-2025 a las 16:27:12
...
INSERT INTO `pedidos_items` (`id`, `id_pedido`, `id_insumo`, `id_suministro`, `cantidad_solicitada`, `cantidad_aprobada`, `cantidad_entregada`) VALUES
(4, 3, 2, NULL, 100, 100, 0),
(5, 4, 4, NULL, 10, 9, 0),
(6, 5, 1, NULL, 500, 401, 0),
(7, 5, 5, NULL, 10, 0, 0);
...
INSERT INTO `pedidos_servicio` (`id`, `tipo_insumo`, `id_usuario_solicitante`, `servicio_solicitante`, `prioridad`, `frecuencia_compra`, `fecha_solicitud`, `estado`, `fecha_aprobacion_director`, `fecha_aprobacion_logistica`, `id_director_aprobador`, `id_logistica_aprobador`, `fecha_entrega_real`, `id_usuario_entrega`, `observaciones_director`, `observaciones_logistica`, `observaciones_entrega`, `paso_actual_id`, `proceso_origen`) VALUES
(3, 'insumos_medicos', 8, 'Laboratorio', 'Normal', 'Mensual', '2025-12-11 14:08:11', 'esperando_entrega', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'movimiento_insumos'),
(4, 'insumos_medicos', 8, 'Laboratorio', NULL, NULL, '2025-12-11 14:11:14', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 'movimiento_insumos'),
(5, 'insumos_medicos', 8, 'Laboratorio', 'Normal', 'Mensual', '2025-12-11 16:12:28', 'esperando_entrega', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'adquisicion_insumos');
...
(1, 'ver_dashboard', 'Ver Panel Principal (Dashboard)', '1. General'),
(2, 'hacer_pedido_interno_insumos', 'Solicitar Retiro Insumos (Interno)', '2. Solicitudes'),
(3, 'hacer_compra_insumos', 'Solicitar COMPRA Insumos Médicos', '2. Solicitudes'),
(4, 'hacer_pedido_interno_suministros', 'Solicitar Retiro Suministros (Interno)', '2. Solicitudes'),
(5, 'hacer_compra_suministros', 'Solicitar COMPRA Suministros Grales', '2. Solicitudes'),
(6, 'ver_stock_insumos', 'Ver Stock Insumos Médicos', '3. Insumos Médicos'),
(8, 'crear_oc_insumos', 'Crear/Editar OC Insumos', '3. Insumos Médicos'),
(9, 'ver_entregas_insumos', 'Ver Entregas Insumos', '3. Insumos Médicos'),
(10, 'ver_stock_suministros', 'Ver Stock Suministros Grales', '4. Suministros'),
(12, 'crear_oc_suministros', 'Crear/Editar OC Suministros', '4. Suministros'),
(13, 'ver_entregas_suministros', 'Ver Entregas Suministros', '4. Suministros'),
(14, 'ver_historial_pedidos', 'Ver Historial de Pedidos', '5. Reportes'),
(15, 'acceso_admin', 'Acceso Configuración Total', '6. Administración'),
(16, 'ver_oc_insumos_todas', 'Ver TODAS las OC Insumos (Auditor/Compras)', '3. Insumos Médicos'),
(17, 'ver_oc_insumos_propias', 'Ver SOLO Mis OC Insumos (Servicios)', '3. Insumos Médicos'),
(18, 'ver_oc_suministros_todas', 'Ver TODAS las OC Suministros (Logística)', '4. Suministros'),
(19, 'ver_oc_suministros_propias', 'Ver SOLO Mis OC Suministros (Servicios)', '4. Suministros'),
(20, 'dash_alcance_global', 'ALCANCE: Ver estadísticas de TODOS los servicios', '0. Dashboard Config'),
(21, 'dash_kpis_resumen', 'Ver Tarjetas de Contadores (Pendientes, Aprobados...)', 'Dashboard Widgets'),
(22, 'dash_grafico_torta', 'Ver Gráfico de Torta (Distribución Estados)', 'Dashboard Widgets'),
(23, 'dash_grafico_barras', 'Ver Gráfico de Barras (Evolución Mensual)', 'Dashboard Widgets'),
(24, 'dash_tabla_recientes', 'Ver Tabla de Últimos Movimientos', 'Dashboard Widgets'),
(25, 'dash_accesos_rapidos', 'Ver Botones de Acción Rápida (Accesos)', 'Dashboard Widgets'),
(26, 'ver_monitoreo_consumo', 'Ver Monitoreo de Consumo (Stock Servicios)', '5. Reportes');
