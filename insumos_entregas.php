...
// Propósito: Historial de salidas (Compras VE, Depósito CREA)
...
// PERMISOS
// ¿Quién puede CREAR una entrega? (Sacar mercadería)
$puede_entregar = in_array('Administrador', $roles) || 
                  in_array('Encargado Depósito Insumos', $roles) || 
                  in_array('Auxiliar', $roles);
// Compras NO está en la lista de arriba, así que no verá el botón.
