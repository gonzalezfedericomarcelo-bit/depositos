...
// Propósito: Crear OC de Insumos Médicos y notificar al DIRECTOR MÉDICO
...
// Solo Admin y Compras pueden crear
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        // 1. Insertar Cabecera (Estado: pendiente_logistica - aunque lo apruebe el director, usamos este estado interno o 'pendiente_director' si quisieramos, pero 'pendiente_logistica' funciona técnicamente como "pendiente de aprobación")
        $stmt = $pdo->prepare("INSERT INTO ordenes_compra (numero_oc, tipo_origen, id_usuario_creador, estado, observaciones) VALUES (:num, 'insumos', :user, 'pendiente_logistica', :obs)");
        $stmt->execute([
            ':num' => $_POST['numero_oc'],
        ...
        // 4. NOTIFICACIÓN: BUSCAR AL DIRECTOR MÉDICO
        // Aquí está el cambio clave: Avisamos al Director.
        ...
        if ($rolDestino) {
            ...
            $stmtNoti->execute([
                ':rol' => $rolDestino,
                ':msj' => "Nueva OC Médica #{$_POST['numero_oc']} requiere su aprobación.",
...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="insumos_compras.php">Volver</a></li>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card mb-4 border-primary">
                    ...
                    <div class="card-body">
                        <div class="mb-3"><label class="fw-bold">Número OC *</label><input type="text" name="numero_oc" class="form-control" required placeholder="Ej: MED-2025-001"></div>
            ...
            <div class="col-lg-8">
                <div class="card mb-4 border-primary">
                    ...
                    <div class="card-footer bg-white text-end"><button type="submit" class="btn btn-primary btn-lg">Guardar y Enviar al Director</button></div>
                </div>
            </div>
        </div>
    </form>
